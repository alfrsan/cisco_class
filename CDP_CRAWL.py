...
def crawlDevice(ip_address,user,pw):
	...
	for ipInter in int_brief:
		LocalDevice.addIp(ipInter["ROW_intf"])

	LocalDevice.addPortChannel(port_channels)
	for interface in int_status:
		LocalDevice.addIntStatus(interface)
...
def main():
	...
	for d in devices_Crawled:
		print 'Device:',d.hostname
		
		for intbrief in d.ipIntBrief:
			#print 'Device:',d.hostname
			print intbrief['intf-name'],intbrief['prefix']
			
			#print 
			#print intbrief['interface']
			#print intstat['vlan']
		print "---------\n"

			#print intstat['interface']
		...
		#for route in vrf.prefixList:
				#print "\t",route
				#for portchan in d.portChannels:
					#print "\t", portchan
		#print d.intStatus
		#for intstat in d.intStatus:
		 	#print "\t",intstat
		 	#print intstat.keys()
